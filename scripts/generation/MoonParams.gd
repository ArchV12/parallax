...
var crater_size: float = 0.3         # MAXIMUM crater radius as a fraction of moon radius — actual sizes follow a power law below it (most small, big ones rare), see CraterField.make
